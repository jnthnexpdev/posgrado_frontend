...
export class StudentService {
    ...
    registerStudents(idPeriod : string, formData : FormData) : Observable<ServerResponse>{
        const options = { withCredentials : true };
        return this.http.post<ServerResponse>(`${environment.api}alumnos/registrar-alumnos-csv/${idPeriod}`, formData, options);
    }
